 ...
 * @see Zend_Uri
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Uri.php';


/**
 * @see Zend_Http_Client_Adapter_Interface
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Http/Client/Adapter/Interface.php';


/**
 * @see Zend_Http_Response
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Http/Response.php';

/**
 * @see Zend_Http_Response_Stream
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Http/Response/Stream.php';
