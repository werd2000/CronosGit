 ...
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/HttpClient.php';
...
class Zend_Gdata_ClientLogin
{
    ...
    {
        if (! ($email && $password)) {
            require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/AuthException.php';
        ...
        if ($response->getStatus() == 200) {
            ...
            if (array_key_exists('Error', $goog_resp) &&
                ...
                require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/CaptchaRequiredException.php';
