 ...
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Calendar/EventFeed.php';

/**
 * @see Zend_Gdata_Calendar_EventEntry
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Calendar/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_ListFeed
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Calendar/ListFeed.php';

/**
 * @see Zend_Gdata_Calendar_ListEntry
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Calendar/ListEntry.php';
