 ...
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Kind/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_Extension_SendEventNotifications
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Calendar/Extension/SendEventNotifications.php';

/**
 * @see Zend_Gdata_Calendar_Extension_Timezone
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Calendar/Extension/Timezone.php';

/**
 * @see Zend_Gdata_Calendar_Extension_Link
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Calendar/Extension/Link.php';

/**
 * @see Zend_Gdata_Calendar_Extension_QuickAdd
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Calendar/Extension/QuickAdd.php';
