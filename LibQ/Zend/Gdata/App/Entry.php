 ...
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/FeedEntryParent.php';

/**
 * @see Zend_Gdata_App_Extension_Content
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Content.php';

/**
 * @see Zend_Gdata_App_Extension_Edited
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Edited.php';

/**
 * @see Zend_Gdata_App_Extension_Published
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Published.php';

/**
 * @see Zend_Gdata_App_Extension_Source
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Source.php';

/**
 * @see Zend_Gdata_App_Extension_Summary
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Summary.php';

/**
 * @see Zend_Gdata_App_Extension_Control
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Control.php';
