...
*/
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Element.php';

/**
 * @see Zend_Gdata_App_Extension_Author
*/
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Author.php';

/**
 * @see Zend_Gdata_App_Extension_Category
*/
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Category.php';

/**
 * @see Zend_Gdata_App_Extension_Contributor
*/
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Contributor.php';

/**
 * @see Zend_Gdata_App_Extension_Id
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Id.php';

/**
 * @see Zend_Gdata_App_Extension_Link
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Link.php';

/**
 * @see Zend_Gdata_App_Extension_Rights
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Rights.php';

/**
 * @see Zend_Gdata_App_Extension_Title
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Title.php';

/**
 * @see Zend_Gdata_App_Extension_Updated
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Extension/Updated.php';
