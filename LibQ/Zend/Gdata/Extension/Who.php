 ...
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Extension.php';

/**
 * @see Zend_Gdata_Extension_AttendeeStatus
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Extension/AttendeeStatus.php';

/**
 * @see Zend_Gdata_Extension_AttendeeType
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/Extension/AttendeeType.php';
