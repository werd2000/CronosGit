 ...
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Validate/Abstract.php';

/**
 * @see Zend_Validate_Ip
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Validate/Ip.php';
                ...
                if (preg_match('/([^.]{2,10})$/i', end($domainParts), $matches) ||
                    ...
                    if ($this->_options['idn'] &&  isset($this->_validIdns[strtoupper($this->_tld)])) {
                        if (is_string($this->_validIdns[strtoupper($this->_tld)])) {
                            $regexChars += include(BASE_PATH . 'LibQ' . DS . $this->_validIdns[strtoupper($this->_tld)]);
                        } else {
