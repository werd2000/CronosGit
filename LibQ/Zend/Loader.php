...
class Zend_Loader
{
    ...
    public static function loadClass($class, $dirs = null)
    {
        ...
        if ((null !== $dirs) && !is_string($dirs) && !is_array($dirs)) {
            require_once BASE_PATH . 'LibQ' . DS . 'Zend/Exception.php';
    ...
    public static function loadFile($filename, $dirs = null, $once = false)
    {
         ...
         */
        if ($once) {
            include_once BASE_PATH . 'LibQ' . DS . $filename;
        } else {
            include BASE_PATH . 'LibQ' . DS . $filename;
        }
    ...
    {
        trigger_error(__CLASS__ . '::' . __METHOD__ . ' is deprecated as of 1.8.0 and will be removed with 2.0.0; use Zend_Loader_Autoloader instead', E_USER_NOTICE);
        require_once BASE_PATH . 'LibQ' . DS . 'Zend/Loader/Autoloader.php';
    ...
    {
        if ($once) {
            return include_once BASE_PATH . 'LibQ' . DS . $filespec;
        } else {
            return include BASE_PATH . 'LibQ' . DS . $filespec ;
        }
    }
}
