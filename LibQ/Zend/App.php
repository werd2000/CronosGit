 ...
 * Zend_Gdata_Feed
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Feed.php';

/**
 * Zend_Gdata_Http_Client
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Http/Client.php';

/**
 * Zend_Version
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Version.php';

/**
 * Zend_Gdata_App_MediaSource
 */
require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/MediaSource.php';
...
class Zend_Gdata_App
{
        ...
        $applicationId = 'MyCompany-MyApp-1.0')
    {
        ...
        if (!$client instanceof Zend_Http_Client) {
            require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/HttpException.php';
    ...
    public static function setGzipEnabled($enabled = false)
    {
        if ($enabled && !function_exists('gzinflate')) {
            require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/InvalidArgumentException.php';
    ...
    {
        require_once BASE_PATH . 'LibQ' . DS . 'Zend/Http/Client/Exception.php';
        ...
        require_once BASE_PATH . 'LibQ' . DS . 'Zend/Uri/Http.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/HttpAdapterStreamingSocket.php';
        ...
        $minorProtocolVersion = null)
    {
        if (!class_exists($className, false)) {
          require_once BASE_PATH . 'LibQ' . DS . 'Zend/Loader.php';
        ...
        if (!$success) {
            require_once BASE_PATH . 'LibQ' . DS . 'Zend/Gdata/App/Exception.php';
