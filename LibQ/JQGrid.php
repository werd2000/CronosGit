...
class JQGrid
{
    ...
    private $_url;
    /**
     * Propiedad que indica la url donde se editan los datos la grilla
     * @var type string
     */
    private $_editUrl;
    /**
     * Propiedad que indica la altura de la grilla
     * @var type integer
     */
    private $_height = 400;
    private $_toolbar;
    ...
    /**
     * Propiedad que indica si se produce algun evento al selecc una fila.
     * @var type boolean
     */
    private $_onSelectRow = false;
    /**
     * Propiedad que indica el evento al selecc una fila.
     * @var type string
     */
    private $_actionOnSelectRow;

    /**
     * Propiedad que indica si se muestra el botón buscar en el pie de pag
     * @var type boolean
     */
    private $_ifBotonBuscar = true;
    
    /**
     * Propiedad que indica si se muestra el botón agregar en el pie de pag
     * @var type boolean
     */
    private $_ifBotonAgregar = true;
    /**
     * Propiedad que indica si la celda se edita
     * @var boolean 
     */
    private $_cellEdit;
    private $_datosLocal;
//    public $formato_fecha = 'formatter=>date';
    ...
    /**
     * Establece si debe mostrarse el botón Agregar en el pie de pag.
     * @param type $ifBotonAgregar booleam
     */
    public function setIfBotonAgregar($ifBotonAgregar)
    {
        $this->_ifBotonAgregar = $ifBotonAgregar;
    }
    ...
    /**
     * Establece la url de donde se editan los datos la grilla
     * @param type $url string
     */
     ...
     * @param type boolean 
     */
    public function setOnSelectRow($onSelectRow=false)
    {
    ...
    /**
     * Establece que debe hacer cuando se selecciona una fila
     * @param type $action string
     */
    ...
    /**
     * Establece si la celda se edita o no
     * @param boolean $val 
     */
