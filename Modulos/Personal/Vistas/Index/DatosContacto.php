                    ...
                    <tr id="<?php if ($contacto->getId()) echo $contacto->getId(); ?>"
                        ...
                        <td class="editcontrol">
                            <a href="JavaScript:void(0);" 
                               ...
                               idPersonal="<?php if ($this->datos->getId()) echo $this->datos->getId(); ?>" 
                               contexto="contacto_personal" title="Eliminar">
...
<a class="iconoX" href="JavaScript:void(0);" idContacto=<?php echo $contacto->getId(); ?> idProfesional="<?php echo $this->datos->getId(); ?>" title="Eliminar"></a>
